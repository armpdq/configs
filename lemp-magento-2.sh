...
yum install -y php php-common php-mcrypt php-fedora-autoloader php-mysqlnd php-cli php-pdo php-intl php-bcmath php-soap php-pecl-redis php-mbstring php-pecl-geoip php-fpm php-json php-process php-gd php-pecl-zip php-mongodb php-opcache php-xml php-pear php-pecl-igbinary php-devel php-gmp php-pecl-mongodb git
...
wget https://raw.githubusercontent.com/armpdq/configs/master/magento-nginx.conf -O /home/www/nginx.conf.sample
wget https://raw.githubusercontent.com/armpdq/configs/master/i.php -O /home/www/html/pub/i.php
